...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['create_account'])) {
    ...
    if ($email !== $confirm_email) {
        ...
        $sql = "INSERT INTO users (username, password, firstName, lastName, email, mobile_number, address) 
                VALUES ('$username', '$hashed_password', '$firstName', '$lastName', '$email', '$mobile_number', '$address')";
        ...
        <div class="right">
            ...
            <form method="POST" action="">
                ...
                <div class="form-section">
                    ...
                    <button type="submit" name="create_account" href="index.php">CREATE ACCOUNT</button>
                </div>
            </form>
        </div>
    </div>
